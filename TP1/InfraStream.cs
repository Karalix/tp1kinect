...
{
    public class InfraStream : KinectStream
    {
        ...
        public override void Init(KinectSensor sensor, System.Windows.Controls.Canvas canvas)
        {
            ...
            colorBitmap = new WriteableBitmap(sensor.ColorStream.FrameWidth, sensor.ColorStream.FrameHeight, 96.0, 96.0, PixelFormats.Gray16, null);
